					...
					<div class="widget-header">
						<div class="row">
							<div class="col-xl-6 col-md-12 col-sm-12 col-12">
								<h4>Todays Collections </h4>
							</div>
							<div class="col-xl-6 col-md-12 col-sm-12 col-12">
								<!-- <form action="getDailyCollectionReport.html" target="_blank" method="get">
									<input type="hidden" id="dateForDailyCollection" name="dateForDailyCollection">
									<button type="submit" style="border: none;background-color: #fff;margin-top: 20px;">Print PDF</button>
								</form> -->
								 <h4>Collection Amount is :<b> ${todays_collection} </b></h4>
							</div>
						</div>
					</div>
								...
								<tbody>
									...
									<c:forEach var="v" items="${TodaysOrdersDetails}">
										<tr class="text-center">
											...
											<td style="display: none;"><c:out value="${v.orderDate}"></c:out></td>
											<td style="display: none;"><c:out value="${v.dueDate}"></c:out></td>
											...
											<td style="display: none"><c:out value="${v.actualPaid}"></c:out></td>
...
<script type="text/javascript">
	function getDate(){
		...
		document.getElementById("dateForDailyCollection").value = output;
	}
</script>
</body>
</html>