					...
					<div class="widget-header">
						<div class="row">
							<div class="col-xl-12 col-md-12 col-sm-12 col-12">
								<h4>Print Outside Servises Barcode</h4>
							</div>
						</div>
					</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<%-- <a href="printOutsideServesesBarcode.html?orderId=${v.orderId}"
						target="_blank">
...
<!-- 
select c.cMobile,c.gender,c.cName,od.orderId,od.totalQuantity,od.invoiceNo,od.orderDate,od.dueDate from (select id as q from numberdata where id between 1 and 1000) dt join orderdetails od
